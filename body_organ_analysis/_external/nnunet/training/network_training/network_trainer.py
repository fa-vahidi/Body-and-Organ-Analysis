...
try:
    from nnunet.inference.inference_model import TritonNetwork
except ImportError:
    TritonNetwork = type(None)
...
class NetworkTrainer(object):
    ...
    def load_checkpoint_ram(self, checkpoint, train=True):
        ...
        :return:
        """
        if isinstance(self.network, TritonNetwork):
            self.network.update_version_iter()
